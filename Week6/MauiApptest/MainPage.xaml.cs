...
namespace MauiApptest
{
    ...
    public class RPNCalculator : ICalculator
    {
        ...
        public RPNCalculator()
        {
            ...
            "cbrt - (CubeRoot)            cube root of a",
            "exp  - (Exponential)         e^a",
            "ln   - (Natural Logarithm)   ln(a) - requires a > 0",
            "log10- (Log base 10)         log10(a) - requires a > 0",
            ...
            "abs  - (Absolute)            |a|",
            "ceil - (Ceiling)             smallest integer >= a",
            "floor- (Floor)               largest integer <= a",
            "round- (Round)               rounds to nearest integer",
            "min  - (Minimum)             min(a, b)",
            "max  - (Maximum)             max(a, b)",
            "fact - (Factorial)           n! (requires non-negative integer)",
            "pi   - (Constant)            pushes π",
            "e    - (Constant)            pushes e (Euler's number)",
            "deg  - (Degrees->Radians)    converts degrees to radians (unary)",
            "rad  - (Radians->Degrees)    converts radians to degrees (unary)"
            };
